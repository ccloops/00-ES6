...
function displayPics(){
  ...
  // The var declaration was global to the entire function; however, the let declaration, when used inside a block, limits the variable's scope to that block, which throws an error when rando is console logged outside of the block. The error therefore, says that 'rando' is not defined.
  console.log(viewed)
